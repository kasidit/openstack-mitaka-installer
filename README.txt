...
In case you want to install OpenStack mitaka and deploy drv 
network, run the following commands. 
...
with classic open vswitch network deployed. Before the integration
you have to delete all instances, routers, and networks from your 
OpenStack deployment. Make sure the ODL host is running and all the 
installation requirements on the ODL-side are met. Then, run
